 ...
 */
class Version20140128092058 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE barcodes CHANGE uuid uuid VARCHAR(36) NOT NULL, CHANGE barcode barcode VARCHAR(14) NOT NULL");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE barcodes CHANGE uuid uuid CHAR(36) NOT NULL, CHANGE barcode barcode CHAR(14) DEFAULT NULL");
    }
}
